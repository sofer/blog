...
category: "money"
standfirst: "In my ongoing attempt to resurrect Keynes to his rightful place as the first person to call this current crisis, I have contributed a new section to the entry on the balance of trade on Wikipedia."
---  
In my ongoing attempt to resurrect Keynes to his rightful place as the first person to call this current crisis, I have contributed a new section to "the entry on the balance of trade":http://en.wikipedia.org/wiki/Balance_of_trade#John_Maynard_Keynes_on_the_balance_of_trade on Wikipedia.
...
[I also greatly expanded "GC's entry":http://en.wikipedia.org/wiki/Geoffrey_Crowther ]
